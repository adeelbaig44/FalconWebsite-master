...
<div class="account_auctionlist_content">
  ...
  <tr class="back_icon_text">
    ...
    <td width="20">|</td>
    <td width="98%">Manage Partners</td>
  </tr>
</table></div>
<BR><BR>
...
if($_POST){
$pl_id = $_POST['pl_id'];
$delete_partner = $_POST['delete_partner'];
if ($_POST['delete_partner']){

$delete = mysqli_query($login_db,"DELETE FROM sm_partnership WHERE ps_id='$pl_id'") or die (mysqli_error());
...
else
{
	...
	if (!$insert = mysqli_query($login_db,"INSERT INTO sm_partnership VALUES ('',
			'','$newName')"))	
	...
	echo "<div class='alert alert-success'><center>Your image has been uploaded.</div>";}
	}	
}
	}
	}
...
?>
<form id="form1" name="form1" method="post" class="table table-striped" enctype="multipart/form-data" action="index.php?view=manage_partners">
...
<tr>
	 ...
	 <tr>
      <td align="center">Size: 350 x 350px:</td>
...
<table width="1000" border="0" class="table table-striped">
  <tbody>
  <?php
				$GetWebSlider = mysqli_query($login_db,"SELECT * FROM sm_partnership") or die("Error with querry");
    ...
    <tr bgcolor="#E5E5E5">
      <td width="72"><?php echo $ps_id;?></td>
      <td width="791"><img src="../_img/clients/<?php echo $ps_image;?>" height="150"></td>
      <form id='form1' name='form1' method='post' action='index.php?view=manage_partners'>
	  <td width="115" align="center" >
	  <input type='hidden' id='pl_id' name='pl_id' value='<?php echo $ps_id;?>'>
	  <input type='submit' id='btn' name='delete_partner' value='Delete'>
		</td></form>
    </tr>
	<?php }
